  ...
  return (
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="grid max-w-md grid-cols-1 gap-6 mx-auto mt-8 text-center lg:max-w-full lg:mt-16 lg:grid-cols-3">
          {services.map((item, i) => (
         <div className="overflow-hidden bg-green-400 border-2 border-gray-300 rounded-md">             
              <div className="p-8 xl:px-12 flex flex-col items-center justify-center">
                 ...
                 <h2 className='font-bold text-3xl text-blue-900 text-center mt-2'>
                   {item.title}
                 </h2>
