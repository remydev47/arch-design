   ...
   <div className="px-6 mx-auto sm:px-8 lg:px-12 max-w-6xl">
       <div className="w-full lg:w-2/3 xl:w-1/2">
           ...
           <p className="mt-6 tracking-tighter text-black">
               <span className="font-sans font-normal text-5xl">The road to the</span><br />
               <span className="font-serif italic font-normal text-6xl">perfect Cleaning Services</span>
           </p>
