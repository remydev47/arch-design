...
const footerNav = {
    ...
    ContactUs:[
      ...
      {
        title: " 16/A, Nairobi, New York, United States, NY, 10005 ",
        href: "/#"
      },
      {
        title: "codearchitecture@gmail.com",
        href: "/#"
      },
      {
        title: "Directions",
...
const Footer = () => {
    return (
    <footer className="mt-3 bg-[#fcb900] dark:bg-slate-900">
          ...
          <div className="grid grid-cols-1 gap-y-6 gap-x-6 md:!grid-cols-6 md:gap-8 xs:grid-cols-2">
            <div className="mb-4  flex flex-col xs:col-span-2">
              ...
              <p className="mt-4 max-w-screen-xs text-sm font-semibold">
                We are on an unwavering mission to be Kenyas most loved Architecture STUDIO
                platform, helping people discover DREAM HOUSES at Low Prices.
              </p>
              <ul
