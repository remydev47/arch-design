...
<div className="relative">
   <div className="px-6 mx-auto sm:px-8 lg:px-12 max-w-6xl">
       <div className="w-full lg:w-2/3 xl:w-1/2">
           <h1 className="font-sans text-base font-bold tracking-tight text-black text-opacity-70">We create Your DREAM IDEAS</h1>
           <p className="mt-6 tracking-tighter text-black">
               <span className="font-sans font-normal text-5xl text-gray-400">We Create your Dream</span><br />
               <span className="font-serif italic font-normal text-6xl text-yellow-400">Ideas with Architectural Design</span>
           </p>
