  ...
  return (
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="max-w-xl mx-auto mt-4 text-4xl font-normal leading-relaxed text-blue-700">
           WHAT WE PROVIDE
          </p>
        </div>
        ...
        <div className="grid max-w-md grid-cols-1 gap-6 mx-auto mt-8 text-center lg:max-w-full lg:mt-16 lg:grid-cols-3">
          {services.map((item, i) => (
         <div className="overflow-hidden bg-[url('/images/bg_pattern_12.jpg')]  border-gray-300 rounded-md">             
