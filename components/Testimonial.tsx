...
const Testimonial = () => {
  return (
    <section className="py-12 bg-[url('/images/bg_pattern_10.jpg')] sm:py-16 lg:py-20">
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
            <div className="text-center">
                <p className="text-lg font-medium text-white font-pj">2,157 people have said how good Codedesign Architecture</p>
                    ...
                    <div className="flex flex-col overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            ...
                            <div className="flex items-center mt-8">
                                <img className="flex-shrink-0 object-cover rounded-full w-11 h-11" src="/images/test2.jpg" alt="" />
                                <div className="ml-4">
                                    <p className="text-base font-bold text-gray-900 font-pj">Leslie Alexander</p>
                                    <p className="mt-0.5 text-sm font-pj text-gray-600">Interior Designer</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <h1 className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“Simply the best. Better than all the rest. I’d recommend this Service to Commercial Premises.”</p>
                                </h1>
                            </div>

                            <div className="flex items-center mt-8">
                                <img className="flex-shrink-0 object-cover rounded-full w-11 h-11" src="/images/test1.jpg" alt="" />
                                <div className="ml-4">
                    ...
                    <div className="flex flex-col overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“I cannot believe that I have got a brand new clients after getting an Office Remake. It was super easy to subscribe to Codesign services.”</p>
                                </blockquote>
                            </div>
                            ...
                            <div className="flex items-center mt-8">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="mt-0.5 text-sm font-pj text-gray-600">Founder Ref corp</p>
                                </div>
                            </div>
                        </div>
                    </div>
